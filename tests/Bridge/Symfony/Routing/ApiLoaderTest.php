...
use ApiPlatform\Core\Operation\Factory\SubresourceOperationsFactory;
...
class ApiLoaderTest extends TestCase
{
    ...
    private function getApiLoaderWithResourceMetadata(ResourceMetadata $resourceMetadata, $recursiveSubresource = false): ApiLoader
    {
        ...
        $possibleArguments = [
            ...
            'api_platform.action.post_subresource',
            'api_platform.action.delete_subresource',
            'api_platform.action.put_subresource',
            'api_platform.action.patch_subresource',
        ];
        ...
        $subresourceOperationFactory = new SubresourceOperationsFactory($resourceMetadataFactory, $propertyNameCollectionFactoryProphecy->reveal(), $propertyMetadataFactoryProphecy->reveal(), new UnderscorePathSegmentNameGenerator());
